...
@section('style')
    <style>
        ...
        #heroCarousel::after {
            ...
            position: absolute;
            bottom: -100px;
            /* Posisi efek sedikit di bawah carousel */
            left: 0;
            width: 100%;
            height: 200px;
            background: linear-gradient(to bottom, rgb(0, 98, 0), rgb(255, 255, 255));
        ...
        .container section {
            position: relative;
            /* Agar section ini berada di atas efek setengah lingkaran */
            z-index: 2;
            /* Menempatkan section di atas efek setengah lingkaran */
            background: #f0f2f5;
        ...
        .container #fasilitas {
            margin-top: 10px;
            /* Menambahkan margin agar section dimulai dari posisi yang lebih tinggi */
        }
    </style>
@endsection
    ...
    <div id="heroCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                ...
                <div class="carousel-caption mx-6">
                    <h1 class="mt-20">Selamat Datang di Ngulisik - Bus Wisata Tasikmalaya</h1>
                    <p class="mb-3">Nikmati perjalanan wisata dengan layanan bus kami yang nyaman dan aman.</p>
            ...
            <div class="carousel-item">
                ...
                <div class="carousel-caption mx-6">
                    <h1 class="mt-20">Jelajahi Tasikmalaya dengan Ngulisik</h1>
                    <p class="mb-3">Pesan tiket bus wisata Anda dan nikmati pengalaman yang tak terlupakan!</p>
                    <a href="{{ route('pesan.pilihTanggal') }}" class="btn btn-primary">Pesan Tiket Sekarang</a>
                </div>
            </div>
            <div class="carousel-item">
                ...
                <div class="carousel-caption mx-6">
                    <h1 class="mt-20">Wisata Terbaik di Tasikmalaya</h1>
                    <p class="mb-3">Temukan destinasi wisata terbaik dengan bus kami yang nyaman dan aman.</p>
                    <a href="{{ route('pesan.pilihTanggal') }}" class="btn btn-primary">Pesan Tiket Sekarang</a>
                </div>
            </div>
        </div>
